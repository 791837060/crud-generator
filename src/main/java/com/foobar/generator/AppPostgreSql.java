...
public class AppPostgreSql {
    ...
    public static void main(String[] args) throws Exception {
        ...
        rp.setOutputPath("/Users/zenghuikang/crud-generator/src/gen/vault_rate_config");
        rp.setOutputPath("/Users/zenghuikang/crud-generator/src/gen/collateral_record");
        ...
        table = TableContext.withName("vault_rate_config");
        table = TableContext.withName("collateral_record");
        ...
        // generator.setClassNameGenerator(t ->
        // org.apache.commons.text.CaseUtils.toCamelCase(t, true, '_') + "Entity");
