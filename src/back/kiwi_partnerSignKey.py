...
# API密钥: reg001@coinflex.com
    ...
    body = '{"apiKey":"kxfU51Xh6Cg1xm7Gx+7vO1pudhFWrsRN/NlYnEdj/hI="}'
    path='/v2/account/private/subaccount/all'
    body ='[22962673]'
    request_type = 'POST'
    ...
    def header():
        ...
        result1 = base64.b64encode(hmac.new(FlexAssets.api_secret.encode('utf-8'), '1592392841584GET/auth/self/verify12345'.encode('utf-8'),
